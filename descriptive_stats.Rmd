  ...
  tbl_summary(
    ...
    label = 
      list(
        ...
        perc_population_with_high_school_degree ~ "Population with high school degree (%)",
...
summary(table, title = "Descriptive Statistics", labelTranslations = labels, text = TRUE) %>% 
  knitr::kable()
```
