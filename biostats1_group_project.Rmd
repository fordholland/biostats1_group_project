...
hate_crimes_no_out$state[2]

model_4adj = lm(hate_crimes_per_100k_splc ~ perc_population_with_high_school_degree * unemployment + unemployment * gini_index, data = hate_crimes_no_out)
summary(model_4adj)
plot(model_4adj)

anova(model_4adj, model_3adj)
```
